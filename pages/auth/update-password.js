...
export default function UpdatePassword() {
  ...
  return (
    <>
      <Head>
        <title>Update Password · KJ Exchange</title>
        <meta name="description" content="Create a new password for your KJ Exchange account." />
      </Head>
          ...
          <div className="glass rounded-3xl p-6 md:p-8 border border-border/50 shadow-2xl shadow-purple/5">
            ...
            {success ? (
              <div className="mt-6 p-4 bg-green-400/10 border border-green-400/20 rounded-xl text-center">
                ...
                <Link
                  href="/auth/login"
                  className="inline-block mt-3 text-orange hover:underline text-sm"
                >
                  Login Now →
                </Link>
              </div>
